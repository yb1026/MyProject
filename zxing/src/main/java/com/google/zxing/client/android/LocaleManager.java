...
public final class LocaleManager {
	...
	// Locales where Google web search is available. These should be kept in
	// sync with our
	...
	static {
		...
		GOOGLE_COUNTRY_TLD.put(new Locale("cs", "CZ", ""), "cz"); // CZECH
																	// REPUBLIC
		...
		GOOGLE_COUNTRY_TLD.put(new Locale("sk", "SK", ""), "sk"); // SLOVAK
																	// REPUBLIC
	...
	static {
		...
		GOOGLE_PRODUCT_SEARCH_COUNTRY_TLD.put(new Locale("en", "AU", ""),
				"com.au"); // AUSTRALIA
