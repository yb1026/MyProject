...
public class DragGridView extends GridView {
    ...
    public void clicked(int position) {
        ...
        resumeView();
        Log.d("liuy", "点击 Item " + position);
    }

    private void resumeView() {

        if (selectView != null) {
//            selectView.findViewById(R.id.delete_img).setVisibility(INVISIBLE);//删除按钮
    ...
    public void startDrag(int position) {
        ...
        if (selectView != null) {
             ...
             * 移动的图像背景要有区别,并显示删除按钮
             */
            selectView.findViewById(R.id.item_container).setBackgroundColor(Color.parseColor("#f8f8f8"));
